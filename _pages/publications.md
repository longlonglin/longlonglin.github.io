...
<style>
  ...
  .badge-ccfa { background-color: #fceea7; color: #b81414; border: 1px solid #f5d67b; }
  .badge-cas1 { background-color: #e1f5fe; color: #0277bd; border: 1px solid #81d4fa; }
  .badge-info { background-color: #e8f5e9; color: #2e7d32; border: 1px solid #a5d6a7; font-style: italic; }
...
<ul class="pub-list">
  ...
  number={},
  pages={1-12},
  doi={10.1109/TBDATA.2025.3644670}}{% endraw %}</pre></div>
    </details>
  </li>
